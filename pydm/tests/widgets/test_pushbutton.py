...
def test_push_button_alarms(qtbot, signals, test_alarm_style_sheet_map, alarm_severity, alarm_sensitive_content,
    ...
    2. The appearance change to check for is just the alarm content (alarm color)
    3. The alarm color will change only if the alarm sensitivity content Boolean flag is set to True
